...
/**
 * 1110(response) Pooya 8583 message DTO
 * @author sa.gholizadeh [gholizade.saeed@yahoo.com]
 */
public class Message1110 extends MessageAbstract implements IResponseMessageFinAuthRev {
    ...
    public Message1110(ISOMsg isoMsg) throws Exception{
        super(isoMsg);
