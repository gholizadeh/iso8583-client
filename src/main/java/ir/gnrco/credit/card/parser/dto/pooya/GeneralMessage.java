...
/**
 * Pooya 8583 message DTO to use for all kind of message if needed
...
public class GeneralMessage extends MessageAbstract {
    ...
    private OriginalTxData originalTxData; //field 56
    ...
    public OriginalTxData getOriginalTxData() {
        return originalTxData;
    }

    public void setOriginalTxData(OriginalTxData originalTxData) {
