package ir.gnrco.credit.card.parser.dto.pooya;

import ir.gnrco.credit.card.parser.dto.IResponseMessageFinAuthRev;
import ir.gnrco.credit.card.parser.dto.MessageAbstract;
import ir.gnrco.credit.card.parser.dto.OriginalTx;
...
import ir.gnrco.credit.card.parser.helper.ISOParseHelper;
...
/**
 * 1430(response) Pooya 8583 message DTO
 * @author sa.gholizadeh [gholizade.saeed@yahoo.com]
 */
public class Message1430 extends MessageAbstract implements IResponseMessageFinAuthRev {
    ...
    public Message1430(ISOMsg isoMsg) throws Exception{
        super(isoMsg);
    ...
    public MessageType getMTI() { return MessageType.MTI_1430; }
